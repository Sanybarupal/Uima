  ...
  return (
    <div className="max-w-md mx-auto min-h-screen relative flex flex-col">
      ...
      <div className="fixed bottom-6 left-0 right-0 px-6 z-50">
        <nav className="max-w-md mx-auto bg-black border border-white/10 rounded-full h-16 flex justify-around items-center px-4 shadow-2xl shadow-black/50">
          <button 
          ...
          >
            ...
            {activeTab === Tab.Dashboard && <span className="text-xs font-bold uppercase tracking-tighter">Home</span>}
          </button>
          ...
          >
            ...
            {activeTab === Tab.Workouts && <span className="text-xs font-bold uppercase tracking-tighter">Train</span>}
          </button>
          ...
          >
            ...
            {activeTab === Tab.Stats && <span className="text-xs font-bold uppercase tracking-tighter">Stats</span>}
          </button>
          ...
          >
            ...
            {activeTab === Tab.Profile && <span className="text-xs font-bold uppercase tracking-tighter">Profile</span>}
          </button>
        </nav>
      </div>
    </div>
